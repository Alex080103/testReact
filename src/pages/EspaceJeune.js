        ...
        <main>
            ...
            after:opacity-10 after:w-full after:h-full after:absolute after:top-0 bg-cover bg-fixed">
                ...
                <div className="h-auto md:max-w-[100%] z-20 lg:max-w-[90vw] mx-auto aspect-video relative ">
                    ...
                    <img src="assets\img\jeunePage\page_jeunes_thematiques-mobile.jpg" className="object-cover sm:hidden w-full"></img>
                </div>
            </section>
            <section className="text mt-8 min-h-[20vh]" >
            <h2 className="md:block font-title text-3xl md:text-5xl py-4 md:pt-4 pb-8 text-center">Nos Accompagnements</h2>
            <p className="text-md md:text-xl font-bold max-w-[95%] md:max-w-[85%] mx-auto">Selon ta situation, tu peux être accompagné de manière individuelle « classique » mais il est aussi possible de t’engager dans un accompagnement plus intensif.
                ...
                <div className="md:flex mx-auto w-auto justify-center  mt-8 font-bold">
                ...
                <div className=" mt-8 mb-8 md:mb-16 max-w-full xl:max-w-[90%] mx-auto grid justify-items-center">
                    ...
                    <AccordionContent id="2" isClicked={isClicked} toggle={false}>
                    <div className="grid items-center gap-2 grid-cols-1 lg:grid-cols-2 mx-6 xl:w-10/12 xl:mx-auto">
                            <div>
                                ...
                                C’est le conseiller qui détermine la durée et le nombre de phases d’accompagnement.<br></br> L’idée étant d’être en phase avec le jeune accompagné, <span className="italic">une allocation peut être versée.</span></p>
                    ...
                    <AccordionContent id="3" isClicked={isClicked} toggle={false}>
                        ...
                        <div className="grid gap-8 items-center mx-6 xl:w-10/12 xl:mx-auto">
                            ...
                            <div>
                                ...
                                <br></br>
                                <span className="font-bold">Cet accompagnement apporte à un(e) jeune parrainé(e), les conseils et le soutien dans ses démarches professionnelles.</span>
                                <br></br>
                                 ...
                                 <br></br>
                                 <span className="font-bold italic">Le parrainage vise à faciliter l’accès et le maintien dans l’emploi des jeunes de 16 à 25 ans.</span></p>
                            </div>
