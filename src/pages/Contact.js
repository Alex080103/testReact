               ...
               [&>div>label]:font-bold [&>div>label]:text-xl [&>div>label]:italic" >
                <div className="mt-0">
                  ...
                  <div>
                      ...
                      <input type="text" id="subject" className="block p-3 w-full text-sm text-gray-900  rounded-lg border border-gray-600 shadow-sm focus:ring-main-pink focus:border-main-pink " placeholder="Le sujet de votre mail" required></input>
                  </div>
                  
                  <div className="sm:col-span-2">
                      <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 ">Votre message</label>
                      <textarea id="message" rows="6" className="block p-2.5 w-full text-sm text-gray-900  rounded-lg shadow-sm border border-gray-600 focus:ring-main-pink focus:border-main-pink " placeholder="Votre message..."></textarea>
                  </div>
