    ...
    return (
        <div>
            ...
            <div className="grid xl:grid-cols-2 max-w-[95%] mx-auto pt-8">
                ...
                <img src="/assets/img/Mentions/mentions-legales-loupe.png" className=" aspect-video pb-8 max-h-[500px] mx-auto" alt="photo avec une loupe et une inscription 'mentions légales' "></img>
            </div>
        </div>
      );
