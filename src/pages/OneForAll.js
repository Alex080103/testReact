        ...
        <section>
            ...
            <div className="grid  lg:grid-cols-2 max-w-[95%] sm:w-11/12 gap-4 mx-auto mb-8" >
                 <div className="flex flex-col text-lg md:text-xl mt-4 lg:text-xl">
                     <p className="">
                         <span class="text-2xl font-bold text-center">Nos forums et recrutements sont ouverts à tous !!</span><br></br> 
                         <ul className="text-lg ml-2 md:ml-4 italic"> Nous organisons chaque année :
                            <li>
