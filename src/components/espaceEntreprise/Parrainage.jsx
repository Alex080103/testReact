...
const Parrainage = () => {
    ...
    return (
        <section>
                ...
                <div className="grid gap-4 md:w-11/12 border-2 border-main-blue p-4 ">
                    <p className="text-lg sm:text-xl uppercase text-center italic font-bold">Chaque parcours est particulier en fonction des contextes, des personnes et des objectifs à atteindre. Il n'y a pas de "Recette" idéale en matière de parrainage.</p>
                    <p className="text-2xl text-center">Quel est le rôle <span className="text-main-pink font-bold">du parrain et de la marraine?</span></p>
                    <div className="border-4 border-main-green p-4">
                        <p className="text-xl strong font-bold italic">Par exemple c'est : </p>
                        <ul className="ml-4">
            ...
            <UnderAccordionContainer title="Un engagement réciproque"  marginLeft={4}>  
                ...
                <div className="grid gap-4 md:w-11/12 mt-4 border-2 border-main-green p-4 [&>div>p]:text-sm [&>div>p]:md:text-md [&>div>div>p]:text-sm [&>div>div>p]:md:text-md">
                        <h3 className="text-3xl text-center">Le parrainage, <span className="text-main-orange">un engagement réciproque</span></h3>
                    ...
                    <div className="border-4 border-main-blue p-4">
                        <h3 className="text-xl sm:text-3xl">Le conseiller Mission Locale</h3>
                    ...
                    <div className="border-4 border-main-orange p-4">
                        <h3 className="text-xl sm:text-3xl">Le/La jeune parrainé(e)</h3>
                        <ul className="list-disc ml-6">
                    ...
                    <div className="border-4 border-main-purple p-4">
                        <h3 className="text-xl sm:text-3xl">Le parrain / La marraine</h3>
                        <ul className="list-disc ml-6">
