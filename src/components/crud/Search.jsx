    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <Link to="/Crud/:team"  id="teamTabs"  type="button" className={`flex items-center justify-center text-white ${ urlName == ":team" ? "bg-main-green" : "bg-main-red" } font-medium rounded-lg text-sm px-4 py-2   focus:outline-none`}>
                ...
                <button type="button" data-modal-target={urlName == ":team" ? "add-modal-team" : urlName == ":post" ? "add-modal-post" : "default-modal"} 
                data-modal-toggle={urlName == ":team" ? "add-modal-team" : urlName == ":post" ? "add-modal-post" : "default-modal"} 
            ...
            <Modal type={urlName} action={"add"}></Modal>
        </div>
