    ...
    return (
        <section id="forums" className="mb-4 md:mb-8">
            ...
            <swiper-slide key={index}>
                <div className="bg-main-white grid md:grid-cols-[60%_40%] relative border-2 w-[95%] sm:w-[95%] rounded-r-xl h-auto md:max-w-auto lg:max-w-[80%] xl:w-2/3 mx-auto border-main-gray shadow-xl shadow-main-gray">
                ...
                font-title sm:text-xl md:text-2xl col-start-1 col-end-3">{forum.status} !</p>
                    ...
                    <div className="sm:p-4 flex flex-col justify-center md:justify-start md:items-end ">
                        ...
                        <div className="flex sm:mb-12 md:mb-0 md:flex-wrap justify-center">
                            <a href={forum.link} target='_blank' className="w-1/2 sm:w-auto bg-blue-600 hover:bg-blue-700 text-sm sm:text-xl font-bold px-4 py-2 sm:mt-2 md:mt-8 text-main-white mx-auto">Voir la publication</a>
                            ...
                            <a href={forum.video_link} target='_blank'  className="w-1/2 sm:w-auto bg-red-600 hover:bg-red-700 text-sm sm:text-xl font-bold px-4 py-2 sm:mt-2 md:mt-8 text-main-white mx-auto">Voir la vidéo</a>
                        </div>
